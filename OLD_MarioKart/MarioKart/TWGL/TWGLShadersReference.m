...
@implementation TWGLShadersReference {
...
- (void)compileVertexShader:(NSString *)vertexShader
    ...
    glBindAttribLocation(_programHandle, TWGLVertexAttribPosition, "a_Position");
    glBindAttribLocation(_programHandle, TWGLVertexAttribColor, "a_Color");
    glBindAttribLocation(_programHandle, TWGLVertexAttribTexCoord, "a_TexCoord");
    glBindAttribLocation(_programHandle, TWGLVertexAttribNormal, "a_Normal");
...
(NSString *)fragmentShader {
    if ((self = [super init])) {
        ...
        self.matColor = GLKVector4Make(1.0, 0.1, 0.0, 1.0);
